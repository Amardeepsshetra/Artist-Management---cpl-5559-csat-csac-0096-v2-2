<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="edituserforele.aspx.cs" Inherits="WebApplication2.WebForm13" %>
...
input:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
  ...
  <div class="w3-row w3-padding-64" id="menu">
    ...
    <asp:Label ID="Label1" runat="server" Text="UserId"></asp:Label>     <asp:TextBox ID="TextBox11" AutoCompleteType="Disabled" runat="server"></asp:TextBox><br />
    ...
    <asp:Label ID="Label5" runat="server" Text="Department"></asp:Label> 
     <asp:TextBox ID="TextBox4" runat="server" ReadOnly="True" AutoCompleteType="Disabled">Filled By Admin</asp:TextBox><br />
     <br />
    ...
    <asp:Button ID="Button2" runat="server" Text="Show Data" class="btn btn-primary btn-block btn-large"  OnClick="Button2_Click" />
        <asp:Button ID="Button1" runat="server" Text="Save" class="btn btn-primary btn-block btn-large"  OnClick="Button1_Click" />
        <asp:Button ID="Button3" runat="server" Text="Delete" class="btn btn-primary btn-block btn-large"  OnClick="Button3_Click" />
</div>
      </div>
</asp:Content>
