<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeBehind="MyprofileReg.aspx.cs" Inherits="WebApplication2.WebForm9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTop" runat="server">
    ...
    <asp:Button ID="Button2" runat="server" Text="Show Data" OnClick="Button2_Click" /><asp:Button ID="Button1" runat="server" Text="Edit" OnClick="Button1_Click" /><asp:Button ID="Button3" runat="server" Text="Request Elevated Access" />
</asp:Content>
