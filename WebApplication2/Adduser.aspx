...
<body>
    ...
    <asp:Label ID="Label4" runat="server" Text="AccessType"></asp:Label> <asp:TextBox ID="TextBox3" runat="server" AutoCompleteType="Disabled" ReadOnly="True" >Regular User</asp:TextBox><br />
    <asp:Label ID="Label5" runat="server" Text="Department"></asp:Label> <asp:TextBox ID="TextBox4" runat="server" AutoCompleteType="Disabled" ReadOnly="True">Filled By Admin</asp:TextBox>
    <br />
    ...
    &nbsp;<br />
    <asp:Label ID="Label10" runat="server" Text="Phone Number"></asp:Label> <asp:TextBox ID="TextBox9" AutoCompleteType="Disabled" runat="server"></asp:TextBox><br />
